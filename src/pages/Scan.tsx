...
type ScanState = 'idle' | 'preview' | 'uploading' | 'scanning' | 'done'
...
export function Scan() {
  ...
  return (
    <div className="flex flex-col items-center px-6 py-6">
      ...
      {error && (
        <p className="mt-4 w-full rounded-lg bg-red-50 p-3 text-sm text-red-600" role="alert">
          {error}
        </p>
      )}
        ...
        <div className="mt-6 flex w-full flex-col items-center gap-3">
          <div className="h-2 w-full max-w-sm overflow-hidden rounded-full bg-gray-200">
            <div
              ...
              style={{ width: state === 'uploading' ? '30%' : `${30 + progress * 0.7}%` }}
            />
          </div>
          <p className="text-sm text-gray-600">
            {state === 'uploading' ? 'Uploading receipt...' : `Scanning text... ${progress}%`}
          </p>
        </div>
      )}
        ...
        <div className="mt-6 flex w-full flex-col items-center gap-4">
          ...
          {ocrText && (
            <div className="w-full max-w-sm">
              <p className="text-xs font-medium text-gray-500 uppercase">Extracted Text</p>
